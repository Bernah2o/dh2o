# Generated by Django 4.2.1 on 2024-03-10 22:54
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "ordenes_trabajo",
                    models.ManyToManyField(blank=True, to="authApp.ordendetrabajo"),
                ),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("fecha", models.DateField()),
                (
                    "imagen_antes_lavado_1",
                    models.ImageField(null=True, upload_to="reportes/"),
                ),
                (
                    "imagen_antes_lavado_2",
                    models.ImageField(null=True, upload_to="reportes/"),
                ),
                (
                    "imagen_despues_lavado_1",
                    models.ImageField(null=True, upload_to="reportes/"),
                ),
                (
                    "imagen_despues_lavado_2",
                    models.ImageField(null=True, upload_to="reportes/"),
                ),
                ("proxima_limpieza", models.DateField(blank=True, null=True)),
                ("creacion", models.DateTimeField(auto_now_add=True)),
        ...
        migrations.AddField(
            ...
            field=models.ManyToManyField(
                ...
                through="authApp.ServicioEnOrden",
                to="authApp.servicio",
            ),
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "mpago",
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE, to="authApp.mpago"
                    ),
                ),
                (
                    "orden_de_trabajo",
